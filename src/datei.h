 ...
 *  @package   compress
 *  @file      datei.h
 *  @brief     Include-Datei fuer das Programm "datei.c"
 ...
 *
 *  datei.h - Include-Datei fuer das Programm "datei.c"
 ...
 *  @fn       MP_berechnung
 *  @return   int
 *  @brief    Lauflaengenkompression berechnen  
 */
int MP_berechnung(void);

/**
 *  @fn       MP_ausgabe(int VV_dateilaenge)
 *  @param    VV_dateilaenge
 *  @brief    Ausgabe des Kompressionsgrades auf StdOut  
 */

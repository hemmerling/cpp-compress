 ...
 *  @package   compress
 *  @file      einsdiff.c
 *  @brief     Ermittelung der "Erste Differenzen" von in einer Binaerdatei
 *             gespeicherten Daten 
 ...
 *
 *  einsdiff.c - Ermittelung der "Erste Differenzen" von in einer Binaerdatei
 *               gespeicherten Daten 
...
/* Ausgabe der ersten 21 Orginaldaten und 1.Differenzen auf StdOut */
/*******************************************************************/
{
  int LV_zaehler;
  printf("\n");
...
/*******************************************************************/
{
  ...
  /* Erste Differenzen berechnen */
  PV_laenge = MP_berechnung();

  #ifdef DEBUGGEN
  /* Ausgabe der ersten 21 Orginaldaten und 1.Differenzen */

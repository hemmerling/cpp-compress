 ...
 *  @package   compress
 *  @file      zweidiff.h
 *  @brief     Include-Datei fuer das Programm "zweidiff.c"
 ...
 *
 *  zweidiff.h - Include-Datei fuer das Programm "zweidiff.c"
